...
const EmployeeExtraDetails = ({name, status, occupation, occupationDescription, address, workspace,}) => {
  return (
    <ScrollView>
      <View style={styles.container}>
        <Card style={styles.innerContainer}>
          <View>
            ...
            <Card style={styles.columnContainer}>
              <View>
                <Text style={[styles.center, styles.lgSize, styles.bold]}>
                  {status
                    ? `Status:  ${status}`
                    : `No status has been chosen for ${name}`}
                </Text>
              </View>
            </Card>
            <Card style={styles.columnContainer}>
